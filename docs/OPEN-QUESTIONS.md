...
| Q74 | Can a Gullsjúkr be a **specific dead NPC Bound** — their name, their gear, their stave going cold? | `DES-017` | Strongly recommended. Confirm before ADR-027's death-record format is fixed |
| Q76 | Gold-baiting cost — flat, or proportional to what you carry? | `DES-017` | Proportional; the richer you are, the more it takes to be interesting |
| Q78 | Does the Ear show *other players'* Clamor in co-op? | `DES-018` | Yes, small, on the party frame rather than the Ear |
| Q79 | Haptic channel as a third twin? | `DES-018` | Recommended — cheap, helps players using neither channel comfortably |
