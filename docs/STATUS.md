...
`0/43` tasks complete across the roadmap. Progress is **scope covered, never time remaining** (ADR-034).

```mermaid
flowchart LR
  M0["M0 Design Lock<br/>0/0"]:::passed
  M1["M1 The Feel Prototype<br/>0/10"]:::current
  M0 --> M1
...
| ▶ | **M1** The Feel Prototype<br><sub>×1</sub> | `░░░░░░░░░░` | 0/10 | `EXIT` pending |
...
_39 docs (39 accepted) · 65 ADRs · 15 open questions · 75 ⟨tune⟩ markers._
