...
`26/54` tasks complete across the roadmap. Progress is **scope covered, never time remaining** (ADR-034).
...
flowchart LR
  ...
  M0 --> M1
  M2["M2 The Loop Prototype<br/>16/16"]:::current
  M1 --> M2
...
| ▶ | **M2** The Loop Prototype<br><sub>×1.5</sub> | `███████████████` | 16/16 | `EXIT` pending<br>`COOP` pending |
...
_39 docs (39 accepted) · 109 ADRs · 12 open questions · 103 ⟨tune⟩ markers._
